      <nav class="navbar col-lg-12 col-12 px-0 py-0 py-lg-4 d-flex flex-row">
        <div class="navbar-menu-wrapper d-flex align-items-center justify-content-end">
          ...
          <h4 class="font-weight-bold mb-0 d-none d-md-block mt-1">Welcome back, {{Auth::guard('admins')->user()->name }}</h4>
          ...
          <ul class="navbar-nav navbar-nav-right">
            <li class="nav-item nav-profile dropdown">
              <a class="nav-link dropdown-toggle" href="#" data-bs-toggle="dropdown" id="profileDropdown">
                ...
                <span class="nav-profile-name">{{Auth::guard('admins')->user()->name }}</span>
              </a>
              <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="profileDropdown">

                @if(Auth::guard('admins')->user()->status == 1 )
                <a href="{{route('admin.addadmin')}}" class="dropdown-item">
                  <i class="mdi mdi-settings text-primary"></i>
                  Add Admin
                </a>
                @endif
                
                <a class="dropdown-item" href="{{route('admin.dologout')}}">
